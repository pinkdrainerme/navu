...
const Weather = () => {
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-sun", id: "weather-section", scrollable: true, title: "We're Most Specialised in" }, getDays()));
};
const Tools = () => {
    const getTools = () => {
        return [{
    ...
    return (React.createElement(MenuSection, { icon: "fa-solid fa-toolbox", id: "tools-section", title: "Business Partners" }, getTools()));
};
const Restaurants = () => {
